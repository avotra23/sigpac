...
admin.site.register(RegistreCSCA)
admin.site.register(RegistreRP)
admin.site.register(PersonneMoraleRP)
admin.site.register(PersonnePhysiqueRP)
admin.site.register(AutresMenuRP)